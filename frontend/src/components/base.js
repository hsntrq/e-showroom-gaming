                ...
                <form>
                  <div className="form-row">
                    <div className="form-group col-sm-4">
                      <label className="sr-only" htmlFor="usrname">
                        User Name
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="form-group col-sm-4">
                      <label className="sr-only" htmlFor="usrpwd">
                        Password
                      </label>
                      <input
                        type="password"
      ...
      <nav className="navbar navbar-light navbar-expand sticky-top navigation-clean">
        <div className="container">
          ...
          <div className="dropdown">
            ...
            >
              <img
                ...
                className="img-fluid"
                alt="*"
                style={{ borderRadius: "50%", height: "37px", width: "40px" }}
              />
            </button>
            <form
              id="category_menu"
          ...
          <div className="nav-item">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBYGNF0Lv85kivjrD7rl65B9DhEVvbOzRjVg&usqp=CAU"
              className="img-fluid"
              alt="*"
              style={{ borderRadius: "50%", height: "37px", width: "40px" }}
            />
